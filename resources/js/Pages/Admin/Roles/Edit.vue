...
<template>
    <Head title="تعديل الدور" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">تعديل الدور</h2>
                    <p class="mt-1 text-sm text-gray-600">تعديل بيانات الدور وصلاحياته</p>
                </div>
                <Link 
        ...
        <div class="max-w-5xl mx-auto">
            <!-- System Role Warning -->
            <div v-if="role.is_system" class="mb-6 bg-yellow-50 border-r-4 border-yellow-500 text-yellow-800 p-4 rounded-lg">
                <div class="flex items-center">
                    <svg class="h-5 w-5 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                    <p class="font-medium">هذا دور نظام ولا يمكن تعديله</p>
                </div>
            </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        :class="{ 'border-red-500': form.errors.name, 'bg-gray-100': role.is_system }"
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        :disabled="role.is_system"
                                        :class="{ 'border-red-500': form.errors.display_name, 'bg-gray-100': role.is_system }"
                                    />
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                        :disabled="role.is_system"
                                        :class="{ 'bg-gray-100': role.is_system }"
                                    ></textarea>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        >
                                            <input
                                                ...
                                                :disabled="role.is_system"
                                                class="mt-1 h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 disabled:opacity-50"
                                            />
                                            <div class="flex-1">
