    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">إضافة مستخدم جديد</h2>
                    <p class="mt-1 text-sm text-gray-600">إنشاء مستخدم جديد وتعيين أدواره</p>
                </div>
                <Link 
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    />
                                    <p class="mt-1 text-xs text-gray-500">يمكن استخدام الأحرف الإنجليزية والأرقام والشرطة السفلية</p>
